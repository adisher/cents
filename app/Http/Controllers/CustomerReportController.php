...
class CustomerReportController extends Controller
{
    ...
    public function generate(Request $request)
    {
        ...
        $budgetSummary = $project->projectBudget ? [
            'total_budget' => $project->projectBudget->total_budget,
            'total_spent' => $project->projectBudget->total_spent,
            'remaining' => $project->projectBudget->remaining_budget,
            'utilization' => $project->projectBudget->utilization_percentage
        ] : null;
